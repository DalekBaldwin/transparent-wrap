...
(deftest test-generic-key ()
  (do-test :generic-key 1)
  (do-test :generic-key 1 2)
  (do-test :generic-key 1 2 :c 3)
  (do-test :generic-key (list 1))
  (do-test :generic-key (list 1) 2)
  (do-test :generic-key (list 1) 2 :c 3))

(deftest test-generic-rest ()
  (do-test :generic-rest 1)
  (do-test :generic-rest 1 2)
  (do-test :generic-rest 1 2 :c 3)
  (do-test :generic-rest (list 1))
  (do-test :generic-rest (list 1) 2)
  (do-test :generic-rest (list 1) 2 :c 3))

(deftest test-generic-rest-key ()
  (do-test :generic-rest-key 1)
  (do-test :generic-rest-key 1 2)
  (do-test :generic-rest-key 1 2 :c 3)
  (do-test :generic-rest-key (list 1))
  (do-test :generic-rest-key (list 1) 2)
  (do-test :generic-rest-key (list 1) 2 :c 3))
